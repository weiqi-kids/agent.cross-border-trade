...
2. **中荷磋商進展**（來源：cn_export_control/regulation_update/2025-11-20-商务部新闻发言人就荷经济大臣卡雷曼斯就安世半导体问题表态答记者问.md）
...
3. **布魯塞爾磋商**（來源：cn_export_control/regulation_update/2025-11-06-中欧出口管制对话磋商在布鲁塞尔举行.md）
...
3. **安世半導體爭議觀察** — 中荷雙方持續磋商，荷方社交媒體回應顯示立場強硬，中方批評荷方「混淆是非」。此案對全球半導體供應鏈穩定性具指標意義。
...
6. **重稀土管制執行情況追蹤** — 2025-11-08 生效的重稀土管制已執行約 3 個月，建議追蹤全球稀土市場價格變化及主要用戶（光纖設備、顯示器、永磁體製造商）的採購動態。
   *依據：cn_export_control/heavy-rare-earth-export-controls.md*
   *（影響評估為推測）*
